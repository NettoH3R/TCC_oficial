        ...
        <div class="insert">
            ...
            <form id="myForm" action="insert.php" method="POST" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-md-4 ">
                        <input name="nome" type="text" placeholder="Nome da Faixa" value="<?= $medias['nome'] ?>" class="nomeDaFaixa" required> <br> <br>
                ...
                <div class="row rowEspacinho">
                    <div class="col-md-4">
                        ...
                        <div class="letrasRadio">
                            <input type="radio" id="radio1" name="rdoPrivac" value="privado" required class="configRadio">
                            <label for="radio1" style="color: white;">Privada</label>
                        </div>
                        <div class="letrasRadio">
                            <input type="radio" id="radio2" name="rdoPrivac" value="publico" class="configRadio" checked>
        ...
        if ($imageInfo !== false) {
            ...
            if ($deu_certo) {
                if ($deu_certo) {
                    ...
                    $comando = $db->prepare('UPDATE nome = :nome, genero = :genero, caminho = :caminho,
                    capa = :capa, privacidade = :privacidade, descricao = :descricao, fk_usuarios_us_id = :idm WHERE id= :id');

                    $comando->execute([
                        ':nome' => $nome, ':genero' => $_POST['genero'], ':caminho' => $pathMusica,
                        ':capa' => $pathCapa, ':privacidade' => $_POST['rdoPrivac'], ':descricao' => $_POST['descricao'],
                        ':idm' => $user['us_id'], ':id' => $_POST['id']
                    ]);
                } else {
                    die($falhaDeEnvio);
                }
